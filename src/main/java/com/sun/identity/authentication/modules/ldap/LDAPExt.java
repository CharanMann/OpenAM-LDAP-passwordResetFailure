 ...
 *
 * openam-ldap-passwordResetFailure: Created by Charan Mann on 8/15/17 , 11:20 AM.
 */
...
public class LDAPExt extends AMLoginModule {
    // static variables
    ...
    private void processLoginScreen(ModuleState newState) throws AuthLoginException {
            switch (newState) {
                ...
                case CHANGE_AFTER_RESET:
                    ...
                    // Just throw exception for failure message. This will end this authentication flow
                    throw new MessageLoginException(resetMsg);
